...
public class HourlyEmployee extends Employee {
    // class or static variables are listed first here
    public static final double FEDERAL_MINIMUM_WAGE = 15;
//    public static final double ILLEGAL_WAGE = 12;
    // fields
    private double rate;
    ...
    // if a method throws a CHECKED exception, it MUST be declared in a throws clause
    public void setRate(double rate) throws IllegalWageException {
        if(rate < FEDERAL_MINIMUM_WAGE){    // Invalid -> throw exception
            throw new IllegalWageException(
                    String.format(rate + " is an illegal wage." + " Federal minimum is: " + FEDERAL_MINIMUM_WAGE ));
        }
        else {
            this.rate = rate;   // Valid -> assign to field
        }
    }
