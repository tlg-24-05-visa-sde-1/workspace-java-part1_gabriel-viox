...
public class Car extends Vehicle {
    ...
    /*
     * If Location is "Austin" then throw a DestinationUnreachableException
     */
    public void moveTo(String location) throws DestinationUnreachableException {
        if (location.equals("North Austin")) {
            throw new DestinationUnreachableException("Unable to get to " + location + ", because of excessive accidents on 183. ");
        }
        else
